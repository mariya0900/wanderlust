                ...
                child: Container(
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(text: '${_activeTrip.title}\n', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                        TextSpan(text: _months[_activeTrip.month!-1], style: TextStyle(fontSize: 16)),
                        TextSpan(text: ' ~ ${_activeTrip.duration}', style: TextStyle(fontSize: 16)),
                        TextSpan(text: '\n${_activeTrip.description}', style: TextStyle(fontSize: 12)),
                      ],
                    ),
                  )
                )
          ...
          Flexible(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  child: makeOptionContainer(Colors.green[50],'Destination Map'),
                  onTap: (){
          ...
          Flexible(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  child: makeOptionContainer(Colors.green[50],'Set Trip Reminder'),
                  onTap: (){
